...
struct User: Codable, Identifiable, Equatable {
    ...
    static func defaultuser2()-> User {
        return User(id: 4, name: "Pierre", username: "Pepe", email: "PPdu74@myspace.com", address: Address(street: "Rue jean massé", suite: "", city: "Paris", zipcode: "01548", geo: Geo(lat: "1.2545", lng: "0.25484")), phone: "0458745968", website: "JbLaRacaille.fr", company: Company(name: "JeanAndCo", catchPhrase: "Wesh on fait du style ici nous", bs: "bs"))
    }
